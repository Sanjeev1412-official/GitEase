...
export function RepoDetailView({
  ...
  return (
    <div className="flex-1 flex flex-col sm:flex-row w-full bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden animate-in fade-in duration-500 min-h-0" onWheel={handleWheel}>
        ...
        <div className="w-full sm:w-80 sm:min-w-[280px] bg-gray-50/50 border-b sm:border-b-0 sm:border-r border-gray-100 p-4 sm:p-5 flex flex-col space-y-4 overflow-hidden shrink-0">
          ...
          {/* Navigation Pills (Grid View) */}
          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-100 flex-1 content-start">
            {[
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center p-3 rounded-xl text-xs font-medium transition-all shadow-sm ${
                  activeTab === tab.id
        ...
        <div className="flex-1 relative bg-gray-50/30 overflow-hidden">
          {isLoading ? (
            ...
            <>
              {/* TAB 1: SETTINGS */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "settings" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                    ...
                    <div className="space-y-6 bg-white p-8 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <button
                          ...
                          className={`flex items-center justify-center gap-2 py-3.5 px-4 rounded-2xl text-sm font-semibold transition-all ${
                            !isPrivate
              ...
              {/* TAB 2: README EDITOR */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "readme" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <ReadmeEditor
              ...
              {/* TAB 3: ISSUES */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "issues" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <IssueManager
              ...
              {/* TAB 4: COMMITS */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "commits" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
              ...
              {/* TAB 5: BRANCHES */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "branches" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <BranchManager
              ...
              {/* TAB 6: RELEASES */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "releases" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <ReleaseManager
              ...
              {/* TAB 7: ACTIONS */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "workflows" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <WorkflowManager
              ...
              {/* TAB 8: FILES */}
              <div 
                className={`absolute inset-0 overflow-y-auto p-8 custom-scrollbar transition-all duration-800 ease-in-out ${activeTab === "files" ? "opacity-100 translate-y-0 pointer-events-auto z-10 delay-300" : "opacity-0 -translate-y-12 pointer-events-none z-0 delay-0"}`}
                onWheel={handleRightPaneWheel}
              >
                <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  <FileExplorer
